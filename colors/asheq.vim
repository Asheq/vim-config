...
" StatusLine
call s:hl('StatusLineNC' , 'NONE'     , s:normal_bg      , s:dark3)
call s:hl('StatusLine'   , 'NONE'     , s:normal_bg      , s:dark0_hard)
call s:hl('User1'        , 'NONE'     , s:bright_blue    , s:light2)
call s:hl('User2'        , 'NONE'     , s:bright_green   , s:dark0_hard)
call s:hl('User3'        , 'NONE'     , s:bright_green   , s:dark3)
...
call s:hl('String'        , 'Italic' , s:neutral_blue , 'NONE')
