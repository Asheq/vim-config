...
call s:hl('QuickFixLine'  , 'NONE'       , 'NONE'         , s:u_faded_purple)
call s:hl('Search'        , 'NONE'       , 'NONE'         , s:u_faded_yellow)
call s:hl('Substitute'    , 'NONE'       , 'NONE'         , s:u_faded_purple)
call s:hl('Visual'        , 'NONE'       , 'NONE'         , s:faded3)
call s:hl('diffFile'      , 'NONE'       , 'NONE'         , s:faded4)
...
if has('nvim')
  ...
  let g:terminal_color_8  = s:faded1

  " Red
  let g:terminal_color_1  = s:sharp_red
  let g:terminal_color_9  = s:faded_red

  " Green
  let g:terminal_color_2  = s:sharp_green
  let g:terminal_color_10 = s:faded_green

  " Yellow
  let g:terminal_color_3  = s:sharp_yellow
  let g:terminal_color_11 = s:faded_yellow

  " Blue
  let g:terminal_color_4  = s:sharp_blue
  let g:terminal_color_12 = s:faded_blue

  " Magenta
  let g:terminal_color_5  = s:sharp_purple
  let g:terminal_color_13 = s:faded_purple

  " Cyan
  let g:terminal_color_6  = s:sharp_aqua
  let g:terminal_color_14 = s:faded_aqua

  " Light gray
  let g:terminal_color_7  = s:sharp2
  let g:terminal_color_15 = s:sharp5
endif
" }}}
