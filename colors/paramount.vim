...
let s:lighter_black   = { "gui": "#303030", "cterm": "236" }
let s:lightest_black  = { "gui": "#4E4E4E", "cterm": "239" }
...
if &background == "dark"
  let s:bg              = s:black
  let s:bg_subtle       = s:lightest_black
...
call s:h('User2',         {"bg": s:bg_very_subtle, "fg": s:blue})
...
call s:h("QuickFixLine",  {"fg": s:yellow, "cterm": "bold", "gui": "bold"})
...
call s:h("PmenuThumb",    {"fg": s:norm, "bg": s:norm})
